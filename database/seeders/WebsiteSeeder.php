...
HTML;
        ...
        foreach ($services as $index => $service) {
            Service::query()->updateOrCreate(['slug' => $service['slug']], [
                ...
                'content' => RichContentNormalizer::normalize($serviceContent),
...
HTML;
        ...
        foreach ($posts as $index => $post) {
            Post::query()->updateOrCreate(['slug' => $post['slug']], [
                ...
                'content' => RichContentNormalizer::normalize($post['content']),
...
HTML;
        ...
        foreach ($projects as $project) {
            Project::query()->updateOrCreate(['slug' => $project['slug']], [
                ...
                'content' => RichContentNormalizer::normalize($project['content']),
    ...
    private function seedJobs(CarbonInterface $publishedAt): void
    {
        ...
        foreach ($jobs as $job) {
            JobPosting::query()->updateOrCreate(['slug' => $job['slug']], [
                ...
                'content' => RichContentNormalizer::normalize($job['content']),
                'requirements' => RichContentNormalizer::normalize($job['requirements']),
                'benefits' => RichContentNormalizer::normalize($job['benefits']),
                'status' => ContentStatus::Published,
                'published_at' => $publishedAt,
